    ...
    <>
      ...
      <section className="my-5">
        ...
        <div className="flex flex-col md:flex-row gap-10 mt-10">
          ...
          <div className="flex-1 flex flex-col gap-5 justify-center text-center md:text-left">
            <p className="text-pretty text-slate-600">
              As a software engineer with one year of experience. I specialize
              in creating amazing website with modern technologies.
            </p>
            <div>
              <Button asChild>
        ...
        <div className="mt-8 text-pretty space-y-3">
          <p className="">
            My name is{" "}
            <span className="text-primary-600">Alvin Fadli Dwi Mulya</span>.
            I&apos;m a{" "}
            <span className="text-primary-600">software engineer</span> with a
            passion for software development. I enjoy working with any
            programming language, but some of my favorites are{" "}
          ...
          <p className="">
            ...
            at{" "}
            <span className="text-primary-600">Padang State Polytechnic</span>{" "}
            and was recognized as the{" "}
            <span className="text-primary-600">Most Outstanding Student</span>{" "}
            of the IT Department 2022.
          </p>
          <p className="">
            I previously worked as{" "}
            <span className="text-primary-600">Software Engineer Intern</span>{" "}
            at <span className="text-primary-600">Sagara Technology</span> and{" "}
            <span className="text-primary-600">Equnix Business Solutions</span>{" "}
            focusing on research and developments of their digital products. I
            gained a lot of experience both on soft skills and hard skills.
            Currently, I&apos;m working as a part-time{" "}
            <span className="text-primary-600">
          ...
          <p className="">
            ...
            I&apos;m always looking for new opportunities to apply my skills in
            meaningful ways. I&apos;m fluent in both{" "}
            <span className="text-primary-600">Indonesian</span> and{" "}
            <span className="text-primary-600">English</span>, which helps me
